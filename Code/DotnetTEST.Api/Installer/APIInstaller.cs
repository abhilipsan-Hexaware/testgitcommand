...
using ElmahCore;
using DotnetTEST.Api.Filters;
using DotnetTEST.Business.Installer;
using DotnetTEST.Entities.Entities;

namespace DotnetTEST.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetTEST API", Version = version + "-" + branch});
            });
